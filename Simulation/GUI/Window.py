...
class Window:
    ...
    def draw_status(self):
        ...
        text_average_vehicles_per_minute = self.text_font.render(
        ...
        self.screen.blit(text_fps, (5, 0))
        self.screen.blit(text_frc, (5, 30))
        self.screen.blit(text_vehicles_passed, (5, 60))
