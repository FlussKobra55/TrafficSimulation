...
# Nodes
WEST_RIGHT_START = (-b - l + -212, a)
WEST_LEFT_START = (-b - l + -212, -a)
...
SOUTH_2_LEFT_TURN = turn_road(SOUTH_2_RIGHT, WEST_2_LEFT, TURN_LEFT, n)
...
NORTH_2_RIGHT_TURN = turn_road(NORTH_2_RIGHT, WEST_2_LEFT, TURN_RIGHT, n)
